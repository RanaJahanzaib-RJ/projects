...
import 'package:my_project/NotesApp.dart/Splash_Screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  //      'message':"i have learned many things from university,",
  //   },
  //   "ur_PK":{
  //       "Name": "رانا جہانزیب",
  //       "Age":"21",
  //       "Department":"انفارمیشن ٹیکنالوجی",
  //       "Session":"2023-2027",
  //       "University":"اسلامیہ یونیورسٹی بہاولپور",
  //       'message':"میں نے یونیورسٹی سے بہت کچھ سیکھا ہے",
  //     },
  //   };
  //   }
